-- ============================================================
-- Migración 00: Esquema base (strategies, fee_configs, trades, candles, backtest_runs, backtest_results)
-- Ejecutar primero en Supabase SQL Editor o via supabase db push
-- ============================================================
...
CREATE INDEX IF NOT EXISTS ix_strategies_family ON public.strategies (family);
...
CREATE TABLE IF NOT EXISTS public.trades (
    ...
    strategy_id         INTEGER REFERENCES public.strategies(id),
...
CREATE INDEX IF NOT EXISTS ix_trades_source ON public.trades (source);
CREATE INDEX IF NOT EXISTS ix_trades_symbol ON public.trades (symbol);
CREATE INDEX IF NOT EXISTS ix_trades_strategy_family ON public.trades (strategy_family);
CREATE INDEX IF NOT EXISTS ix_trades_strategy_id ON public.trades (strategy_id);
CREATE INDEX IF NOT EXISTS ix_trades_closed_at ON public.trades (closed_at);
CREATE INDEX IF NOT EXISTS ix_trades_created_at ON public.trades (created_at);
...
CREATE INDEX IF NOT EXISTS ix_candles_interval ON public.candles (interval);
...
DROP TRIGGER IF EXISTS trg_fee_configs_updated_at ON public.fee_configs;
