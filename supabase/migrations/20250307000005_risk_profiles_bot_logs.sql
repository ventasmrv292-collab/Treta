-- ============================================================
-- Migración 05: risk_profiles, bot_logs
-- ============================================================
...
DROP POLICY IF EXISTS "Allow all risk_profiles" ON public.risk_profiles;
CREATE POLICY "Allow all risk_profiles" ON public.risk_profiles FOR ALL USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS "Allow all bot_logs" ON public.bot_logs;
CREATE POLICY "Allow all bot_logs" ON public.bot_logs FOR ALL USING (true) WITH CHECK (true);
