-- ============================================================
-- Migración 001: Nuevas tablas (paper_accounts, account_ledger, signal_events, backtest_equity_curve)
...
-- B) signal_events (antes de alterar trades, para poder referenciar desde trades)
...
-- D) account_ledger (referencias a paper_accounts, trades, backtest_runs)
