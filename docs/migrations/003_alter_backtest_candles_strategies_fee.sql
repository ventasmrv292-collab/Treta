-- ============================================================
-- Migración 003: ALTER backtest_runs, candles, strategies, fee_configs
-- ============================================================
...
-- D) strategies: unique (family, name, version)
...
-- E) fee_configs: solo un is_default = true (partial unique index)
